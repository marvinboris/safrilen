            ...
            <div className="px-[33px] xl:px-[42px] pt-[29px] xl:pt-[47px] pb-[54px]">
                ...
                <div className="grid gap-2.5 md:grid-cols-2 xl:grid-cols-4 mb-[51px] lg:mb-[35.08px]">
                    ...
                    <StatCard color='sky' title={blocks.testimonials}>
                        <div className="flex items-end justify-between">
                            <div className='pb-[7px] md:pb-[5px]'>
                                <span className="font-bold text-3xl md:text-lg">{data && data.blocks && data.blocks.testimonials}</span>
                            </div>

                            <div><ChatBubbleOvalLeftEllipsisIcon className='w-20 md:w-11 text-sky/20' /></div>
                        </div>
                    </StatCard>
                    ...
                    <StatCard color='yellow' title={blocks.images}>
                        <div className="flex items-end justify-between">
                            <div className='pb-[7px] md:pb-[5px]'>
                                <span className="font-bold text-3xl md:text-lg">{data && data.blocks && data.blocks.images}</span>
                            </div>

                            <div><PhotoIcon className='w-20 md:w-11 text-black/10' /></div>
                        </div>
                    </StatCard>
                </div>
            </div>
