...
export default function GetQuote() {
    ...
    return <View action={<Button color="white" size='sm'><span className='font-medium hidden md:inline'>{menu.quote}</span><span><BoltIcon className='md:ml-2 inline-block w-5 text-primary/60 group-hover:text-primary transition-all duration-200' /></span></Button>}>
